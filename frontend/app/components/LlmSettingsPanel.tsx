  ...
  return (
    <div className="card-dev flex flex-col gap-4 p-4 max-w-lg">
      ...
      <div className="flex items-center gap-3">
        <span className="text-xs font-medium text-foreground font-sans">Provider</span>
        <button
          type="button"
          role="switch"
        ...
        >
          <span
            className={`pointer-events-none absolute inset-y-1 flex h-6 w-[5.25rem] items-center justify-center rounded-full text-xs font-medium transition-all text-white ${
              useRemote ? "left-[calc(100%-5.5rem)] bg-accent text-accent-foreground" : "left-1 bg-[#404040] border border-border"
            }`}
          >
      ...
      {useRemote && (
        <div className="flex flex-col gap-3 pt-2 border-t border-[#363636]">
          <div className="flex flex-col gap-1">
            <label className="text-[10px] font-medium uppercase tracking-wider text-muted-foreground font-sans">Base URL</label>
            <input
              type="text"
          ...
          <div className="flex flex-col gap-1">
            <label className="text-[10px] font-medium uppercase tracking-wider text-muted-foreground font-sans">Model</label>
            <input
              type="text"
          ...
          <div className="flex flex-col gap-1">
            <label className="text-[10px] font-medium uppercase tracking-wider text-muted-foreground font-sans">API key</label>
            <input
              type="password"
