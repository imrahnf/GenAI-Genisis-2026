  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-background">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        <div className="flex-shrink-0 px-8 pt-7 pb-4 border-b border-border">
          <p className="text-[13px] text-muted-foreground mb-1">Overview</p>
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-4">
                <button
                  ...
                  className="p-2 hover:bg-secondary rounded-xl text-muted-foreground hover:text-foreground transition-colors -ml-2"
                >
                  <ArrowLeft size={18} />
                </button>
                <h1 className="text-foreground m-0 font-serif text-[28px]">
                  Launch sandbox · {selectedPresetData?.name ?? selectedPreset}
                </h1>
              </div>
            </div>
          ) : (
            <h1 className="text-foreground mb-4 font-serif text-[28px]">
